        ...
        return (
          ...
          function (d, f, g) {
            ...
            f.$$inheritedValues && e(t, m(f.$$inheritedValues, p)),
              R(s, f.$$promises),
              f.$$values ? ((v = e(t, m(f.$$values, p))), (r.$$inheritedValues = m(f.$$values, p)), h()) : (f.$$inheritedValues && (r.$$inheritedValues = m(f.$$inheritedValues, p)), f.then(h, i));
          ...
          (y.transitionTo = function (b, c, f) {
            ...
            if (w(b, c, j, l, G, f))
              return (
                ...
                f.location && b.navigable && b.navigable.url && (p.push(b.navigable.url, c, { $$avoidResync: !0, replace: "replace" === f.location }), p.update(!0)),
                (y.transition = null),
                e.when(y.current)
              );
            ...
            var M = (y.transition = J.then(function () {
              ...
              return y.transition !== M
                ...
                : ((y.$current = b),
                  ...
                  S(y.params, n),
                  (y.transition = null),
                  f.location && b.navigable && p.push(b.navigable.url, b.navigable.locals.globals.$stateParams, { $$avoidResync: !0, replace: "replace" === f.location }),
    ...
    function w() {
      function a(a, b) {
        return {
          load: function (a, c) {
            var d,
              e = { template: null, controller: null, view: null, locals: null, notify: !0, async: !0, params: {} };
