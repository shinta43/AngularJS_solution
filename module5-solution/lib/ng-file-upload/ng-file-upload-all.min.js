...
!(function () {
              ...
              e = {
                ...
                complete: function (a, d) {
                  a && angular.isString(a) && -1 !== a.indexOf("#2174") && (a = null),
                    (c.__completed = !0),
                    !a && c.__listeners.load && c.__listeners.load({ type: "load", loaded: c.__loaded, total: c.__total, target: c, lengthComputable: !0 }),
                    !a && c.__listeners.loadend && c.__listeners.loadend({ type: "loadend", loaded: c.__loaded, total: c.__total, target: c, lengthComputable: !0 }),
                    "abort" === a && c.__listeners.abort && c.__listeners.abort({ type: "abort", loaded: c.__loaded, total: c.__total, target: c, lengthComputable: !0 }),
                    void 0 !== d.status &&
                      b(c, "status", function () {
  ...
  (function () {
    ...
    function c(a) {
      ...
      if (a.offsetParent)
        do (b += a.offsetLeft - a.scrollLeft), (c += a.offsetTop - a.scrollTop), (a = a.offsetParent);
        while (a);
      return { left: b, top: c };
    }
    ...
    (window.FileReader = function () {
      ...
      var c = function (b, c) {
        ...
        d = function (d) {
          ...
          var e;
          "load" === d.type
            ? (a.onloadend && a.onloadend(c("loadend", d)), (e = c("load", d)), a.onload && a.onload(e), a.dispatchEvent(e))
            : "progress" === d.type
            ? ((e = c("progress", d)), a.onprogress && a.onprogress(e), a.dispatchEvent(e))
            : ((e = c("error", d)), a.onerror && a.onerror(e), a.dispatchEvent(e));
        };
        ...
        return (
          ...
          g
            ? d._chunkSize && d._end && !d._finished
              ...
              : (d._chunkSize && ((d._start = 0), (d._end = d._start + d._chunkSize)), i())
            : i(),
          ...
          function c(b, c) {
            ...
            if (((a._file = a._file || b), null != a._start && g)) {
              ...
              return (
                (d.name = b.name),
                (d.ngfName = b.ngfName),
                a._chunkSize && (c.append("_chunkSize", a._chunkSize), c.append("_currentChunkSize", a._end - a._start), c.append("_chunkNumber", Math.floor(a._start / a._chunkSize)), c.append("_totalSize", a._file.size)),
                d
              );
            }
            return b;
      ...
      return (
        ...
        (i.updateModel = function (c, d, e, h, j, k, l) {
          function m(f, g, j, l, m) {
            ...
            c && (i.applyModelValidation(c, f), c.$setViewValue(m ? n : f)), h && a(h)(e, { $files: f, $file: n, $newFiles: j, $duplicateFiles: l, $invalidFiles: g, $invalidFile: o, $event: k });
          ...
          if (!x || r.length) {
            i.attrGetter("ngfBeforeModelChange", d, e, { $files: j, $file: j && j.length ? j[0] : null, $newFiles: r, $duplicateFiles: u, $event: k });
            var z = i.attrGetter("ngfValidateAfterResize", d, e),
              A = i.attrGetter("ngModelOptions", d, e);
            i.validate(r, s.length, c, d, e).then(function () {
              l
                ? m(r, [], j, u, y)
                : ((A && A.allowInvalid) || z ? (w = r) : p(),
                  i.attrGetter("ngfFixOrientation", d, e) && i.isExifSupported()
                    ? f(w, d, e).then(function () {
                        q();
                      })
                    : q());
            });
          ...
          if (b !== a)
            for (var c = 0; c < b[0].attributes.length; c++) {
              ...
              "type" !== d.name &&
                "class" !== d.name &&
                "style" !== d.name &&
                ((null == d.value || "" === d.value) && ("required" === d.name && (d.value = "required"), "multiple" === d.name && (d.value = "multiple")), a.attr(d.name, "id" === d.name ? "ngf-" + d.value : d.value));
            }
        }
        function o() {
          if (k()) return b;
          ...
          return (
            c.css("visibility", "hidden").css("position", "absolute").css("overflow", "hidden").css("width", "0px").css("height", "0px").css("border", "none").css("margin", "0px").css("padding", "0px").attr("tabindex", "-1"),
            g.push({ el: b, ref: c }),
    ...
    function b(b, c, d, e, f, g, h, i) {
      ...
      c(function () {
        var c = d.$watch(f[g], function (c) {
          var d = h;
          if ("ngfThumbnail" === g && (d || (d = { width: e[0].clientWidth, height: e[0].clientHeight }), 0 === d.width && window.getComputedStyle)) {
            var f = getComputedStyle(e[0]);
            d = { width: parseInt(f.width.slice(0, -2)), height: parseInt(f.height.slice(0, -2)) };
          }
          return angular.isString(c)
            ? (e.removeClass("ng-hide"), i ? e.css("background-image", "url('" + c + "')") : e.attr("src", c))
            : void (!c || !c.type || 0 !== c.type.search(a(e[0])) || (i && 0 !== c.type.indexOf("image"))
                ? e.addClass("ng-hide")
                : d && b.isResizeSupported()
                ? b.resize(c, d.width, d.height, d.quality).then(
                    function (a) {
                      j(a);
                    },
                    function (a) {
      ...
      ngFileUpload.filter("ngfDataUrl", [
        ...
        function (a, b) {
          return function (c, d, e) {
            ...
            return c && !f
              ? (!c.$ngfDataUrlFilterInProgress && angular.isObject(c) && ((c.$ngfDataUrlFilterInProgress = !0), a.dataUrl(c, d)), "")
              : (c && delete c.$ngfDataUrlFilterInProgress, (c && f ? (e ? b.trustAsResourceUrl(f) : f) : c) || "");
          };
        },
      ]);
  })(),
        ...
        if (a.length > 2 && "/" === a[0] && "/" === a[a.length - 1]) b = a.substring(1, a.length - 1);
          ...
          if (e.length > 1)
            ...
            0 === a.indexOf("!")
              ...
              : (0 === a.indexOf(".") && (a = "*" + a), (b = "^" + a.replace(new RegExp("[.\\\\+*?\\[\\^\\]$(){}=!<>|:\\-]", "g"), "\\$&") + "$"), (b = b.replace(/\\\*/g, ".*").replace(/\\\?/g, ".")));
        }
      ...
      return (
        ...
        (f.validate = function (a, c, d, e, g) {
                ...
                angular.forEach(a, function (a) {
                  ...
                  return (
                    ...
                    !i || (null != a.type && 0 === a.type.search(i))
                      ? void ("dimensions" === c && null != f.attrGetter("ngfDimensions", e)
                          ...
                          : "duration" === c && null != f.attrGetter("ngfDuration", e)
                          ...
                          : m(d, a, f.getValidationAttr(e, g, c, h, a)))
                      : void d.resolve()
                  );
                }),
                b.all(n).then(
          ...
          return (
            m.push(
              f.happyPromise(
                i("maxHeight", "height.max", /image/, this.imageDimensions, function (a, b) {
                  return a.height <= b;
                })
              )
            ),
            m.push(
              f.happyPromise(
                i("minHeight", "height.min", /image/, this.imageDimensions, function (a, b) {
                  return a.height >= b;
                })
              )
            ),
            m.push(
              f.happyPromise(
                i("maxWidth", "width.max", /image/, this.imageDimensions, function (a, b) {
                  return a.width <= b;
                })
              )
            ),
            m.push(
              f.happyPromise(
                i("minWidth", "width.min", /image/, this.imageDimensions, function (a, b) {
                  return a.width >= b;
                })
              )
            ),
            ...
            m.push(
              f.happyPromise(
                i("maxRatio", "ratio.max", /image/, this.imageDimensions, function (a, b) {
            ...
            m.push(
              f.happyPromise(
                i("minRatio", "ratio.min", /image/, this.imageDimensions, function (a, b) {
                  return a.width / a.height - f.ratioToFloat(b) > -1e-4;
                })
              )
            ),
            m.push(
              f.happyPromise(
                i("maxDuration", "duration.max", /audio|video/, this.mediaDuration, function (a, b) {
            ...
            m.push(
              f.happyPromise(
                i("minDuration", "duration.min", /audio|video/, this.mediaDuration, function (a, b) {
                  return a >= f.translateScalars(b);
                })
              )
            ),
        ...
        (f.mediaDuration = function (a) {
          ...
          return (
            c(function () {
              return 0 !== a.type.indexOf("audio") && 0 !== a.type.indexOf("video")
                ...
                : void f.dataUrl(a).then(
                    function (b) {
                      ...
                      var h = angular
                        .element(0 === a.type.indexOf("audio") ? "<audio>" : "<video>")
                        .attr("src", b)
                        .css("visibility", "none")
                        .css("position", "fixed");
          ...
          return (
            (n.onload = function () {
              ...
              try {
                ...
                p.drawImage(n, Math.min(0, -o.marginX / 2), Math.min(0, -o.marginY / 2), o.width, o.height), l.resolve(m.toDataURL(h || "image/WebP", g || 0.934));
              } catch (q) {
                l.reject(q);
              }
            }),
    ...
    function a(a, c, d, e, f, g, h, i, j, k) {
      ...
      function o(a, b, c, d) {
        ...
        if (angular.isString(e)) f = e;
          ...
          if (null != g && g.length)
            for (var h = e.pattern || r("ngfPattern", a, { $event: c }), j = g.length; j--; ) {
                ...
                p = function () {
                  f.readEntries(
                    function (e) {
                      try {
                        e.length
                          ? ((h = h.concat(Array.prototype.slice.call(e || [], 0))), p())
    ...
    function (a, b) {
      ...
      return (
        ...
        (e.restoreExif = function (a, b) {
          var c = {};
          return (
            (c.KEY_STR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="),
